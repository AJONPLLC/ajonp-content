...
images:
- https://res.cloudinary.com/ajonp/image/upload/q_auto/v1545844636/ajonp-ajonp-com/8-lesson-firestore-functions/auto_gen.webp
languages:
- javascript
- go
- typescript
...
![Fork Example](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545864186/ajonp-ajonp-com/8-lesson-firestore-functions/qvn7dthjxnhelvyg20rv.webp)
...
![Latest Books](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545864982/ajonp-ajonp-com/8-lesson-firestore-functions/dcrwjvqsbycdqflpo4nj.webp)

You can also view all the books in a list format at `http://localhost:1313/books/`.

![All Books](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545865091/ajonp-ajonp-com/8-lesson-firestore-functions/g6mu7mmskbfdb2pdpvdv.webp)
...
![Add Project](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545865510/ajonp-ajonp-com/8-lesson-firestore-functions/mlcfmsxq3egli5llns6i.webp)

Give the project a good name.

![Name Project](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545866565/ajonp-ajonp-com/8-lesson-firestore-functions/s7cmb6rmkkft4v0ag7ps.webp)

You can then follow the Getting started under hosting, or follow the update local firebase files.![](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545866746/ajonp-ajonp-com/8-lesson-firestore-functions/ragqsnmidwfuv1kcb51n.webp)
...
![firebase deploy result](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545874713/ajonp-ajonp-com/8-lesson-firestore-functions/nwsqimwac9suyzhrtdje.webp)
...
![Blaze Plan](https://res.cloudinary.com/ajonp/image/upload/q_auto/v1545875585/ajonp-ajonp-com/8-lesson-firestore-functions/rsuwpz0erldnoexzhowl.webp)
...
![Project Dropdown](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545875207/ajonp-ajonp-com/8-lesson-firestore-functions/ufwyzjjozoxruj7zwqpi.webp)
...
![Cloud Trigger](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545875313/ajonp-ajonp-com/8-lesson-firestore-functions/somhpisvlmnmitqf8apr.webp)

If this is a new project you will need to enable the cloud build API. 

![Cloud Build Enable API](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545875377/ajonp-ajonp-com/8-lesson-firestore-functions/mkfsasxbko8bx70oahfy.webp)

> If you receive an error, please make sure that you have changed to a Blaze Plan in Firebase.![Builder Error](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545875470/ajonp-ajonp-com/8-lesson-firestore-functions/jgp7vmvazhyi4c5p2y64.webp)
...
![Select Source](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545876414/ajonp-ajonp-com/8-lesson-firestore-functions/zc1t0zguz0xnccruayzq.webp)

After you authenticate to GitHub choose your project and continue.

![Choose GitHub project](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545876452/ajonp-ajonp-com/8-lesson-firestore-functions/knehapxggrolfxkpaeor.webp)
...
![Final steps](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545876311/ajonp-ajonp-com/8-lesson-firestore-functions/olckoaopc8tv7xhpjij4.webp)
...
![Trigger History](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545877459/ajonp-ajonp-com/8-lesson-firestore-functions/llkuo8erhprsak23frtv.webp)
...
![Project Settings](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545921872/ajonp-ajonp-com/8-lesson-firestore-functions/msoukza2h7qt3caep5op.webp)

Then select the "Add Firebase to your web app" under the "Your apps" section.
![Your apps](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545921940/ajonp-ajonp-com/8-lesson-firestore-functions/dt6rddue4ra5oezt4fmi.webp)
...
![environment files](https://res.cloudinary.com/ajonp/image/upload/,q_auto/v1545921794/ajonp-ajonp-com/8-lesson-firestore-functions/k4oljh0egz3ajrt9reo8.webp)
...
![Auth Error](https://res.cloudinary.com/ajonp/image/upload/q_auto/v1545922204/ajonp-ajonp-com/8-lesson-firestore-functions/tofhpbinmrcwi8c7kzyt.webp)
...
![Create Database](https://res.cloudinary.com/ajonp/image/upload/w_800,q_auto/v1545922532/ajonp-ajonp-com/8-lesson-firestore-functions/ni4xs9bhwfsexfdf6jho.webp)
...
![Firestore Lock Mode](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545922666/ajonp-ajonp-com/8-lesson-firestore-functions/qcgjr0ld7j9n9vyqji1n.webp)
...
![Find and Replace](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545921323/ajonp-ajonp-com/8-lesson-firestore-functions/fqslxxgc9jyelgl81xkq.webp)
...
![Style Error](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545921409/ajonp-ajonp-com/8-lesson-firestore-functions/hpldbf8rxw9a4f4c2ztj.webp)
...
```
Results
![Angular Build Results](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545923774/ajonp-ajonp-com/8-lesson-firestore-functions/jzryeqykv2bhtzqvyvem.webp)
...
```
Results
![Hosting Deploy Result](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545924120/ajonp-ajonp-com/8-lesson-firestore-functions/bmvevp4ss4g85fnax9jc.webp)
...
![Auth Domains](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545924515/ajonp-ajonp-com/8-lesson-firestore-functions/tjwkte0y4bcml9whonre.webp)
...
![Personal Token](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545925555/ajonp-ajonp-com/8-lesson-firestore-functions/suutevgobgp1hsgvja3k.webp)
...
![Firebase Config](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545925916/ajonp-ajonp-com/8-lesson-firestore-functions/w2goczy3ydk6ypbf1hny.webp)
...
![Successfully Deploy Functions](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545926029/ajonp-ajonp-com/8-lesson-firestore-functions/mneaigflqyxmqoqp557b.webp)
...
![New Book Form](https://res.cloudinary.com/ajonp/image/upload/w_500,q_auto/v1545933791/ajonp-ajonp-com/8-lesson-firestore-functions/xyn381bujrehp021yeju.webp)
...
![Git Creat Log](https://res.cloudinary.com/ajonp/image/upload/q_auto/v1545934369/ajonp-ajonp-com/8-lesson-firestore-functions/bcnequcgzehwyx9hjf1a.webp)
